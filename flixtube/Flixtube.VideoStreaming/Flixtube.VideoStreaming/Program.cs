...
if (string.IsNullOrEmpty(Environment.GetEnvironmentVariable("FLIXTUBE_VIDEO_STORAGE_SCHEME"))) {
    throw new Exception("Please specify the scheme for Flixtube.VideoStorage in variable FLIXTUBE_VIDEO_STORAGE_SCHEME.");
}

if (string.IsNullOrEmpty(Environment.GetEnvironmentVariable("FLIXTUBE_VIDEO_STORAGE_HOST"))) {
    throw new Exception("Please specify the host for Flixtube.VideoStorage in variable FLIXTUBE_VIDEO_STORAGE_HOST.");
}

if (string.IsNullOrEmpty(Environment.GetEnvironmentVariable("FLIXTUBE_VIDEO_STORAGE_PORT"))) {
    throw new Exception("Please specify the port number for Flixtube.VideoStorage in variable FLIXTUBE_VIDEO_STORAGE_PORT.");
}
